...
export function addUser(socketId, roomId) {
...
export function newGame(room, userId, username) {
...
export function getGameDetail(room) {
  return gameDetail.find((item) => item.room === room);
}

export function addMove(room, userId, move) {
...
export function CheckWin(room, userId) {
  let gameDetail = getGameDetail(room);
